...
statusbar =Label(root, text="Welcome to Iplayer", relief=SUNKEN, anchor=W, font='Times 10 italic')
...
def about_us():
    tkinter.messagebox.showinfo('About Iplayer', 'This is a music player build using Python Tkinter Version 1.1')
...
def play_music():
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror('File not found', 'Iplayer could not find the file. Please check again.')
...
rewindBtn = Button(bottomframe, text='rewind', command=rewind_music)
rewindBtn.grid(row=0, column=0)

volumeBtn = Button(bottomframe, text='volume', command=mute_music)
